...
async function loadContext() {
  ...
  const CONTEXT_FILES = [
    ...
    { name: 'SCHEMA.md', path: 'devdocs/SCHEMA.md', category: 'docs', gh: 'devdocs/SCHEMA.md',
    ...
    { name: 'PATTERNS.md', path: 'devdocs/PATTERNS.md', category: 'docs', gh: 'devdocs/PATTERNS.md',
    ...
    { name: 'KEY-FILES.md', path: 'devdocs/KEY-FILES.md', category: 'docs', gh: 'devdocs/KEY-FILES.md',
    ...
    { name: 'DEPLOY.md', path: 'devdocs/DEPLOY.md', category: 'docs', gh: 'devdocs/DEPLOY.md',
    ...
    { name: 'INTEGRATIONS.md', path: 'devdocs/INTEGRATIONS.md', category: 'docs', gh: 'devdocs/INTEGRATIONS.md',
    ...
    { name: 'CHANGELOG.md', path: 'devdocs/CHANGELOG.md', category: 'docs', gh: 'devdocs/CHANGELOG.md',
    ...
    { name: 'CAD.md', path: 'devdocs/CAD.md', category: 'docs', gh: 'devdocs/CAD.md',
    ...
    { name: 'CAD-SITE-PLANS.md', path: 'devdocs/CAD-SITE-PLANS.md', category: 'docs', gh: 'devdocs/CAD-SITE-PLANS.md',
    ...
    { name: 'CAD-RENDER-PIPELINE.md', path: 'devdocs/CAD-RENDER-PIPELINE.md', category: 'docs', gh: 'devdocs/CAD-RENDER-PIPELINE.md',
    ...
    { name: 'HOMEAUTOMATION.md', path: 'devdocs/HOMEAUTOMATION.md', category: 'docs', gh: 'devdocs/HOMEAUTOMATION.md',
    ...
    { name: 'LIGHTINGAUTOMATION.md', path: 'devdocs/LIGHTINGAUTOMATION.md', category: 'docs', gh: 'devdocs/LIGHTINGAUTOMATION.md',
    ...
    { name: 'TESTING-GUIDE.md', path: 'devdocs/TESTING-GUIDE.md', category: 'docs', gh: 'devdocs/TESTING-GUIDE.md',
    ...
    { name: 'SECRETS-GUIDE.md', path: 'devdocs/SECRETS-GUIDE.md', category: 'docs', gh: 'devdocs/SECRETS-GUIDE.md',
    ...
    { name: 'home-assistant-lighting-design.md', path: 'devdocs/home-assistant-lighting-design.md', category: 'docs', gh: 'devdocs/home-assistant-lighting-design.md',
