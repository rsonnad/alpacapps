...
if curl -s http://localhost:9997/v3/paths/list > /dev/null 2>&1; then
    ...
    echo "  RTSP:   rtsp://192.168.1.200:8554/{stream-name}"
    echo "  HLS:    http://192.168.1.200:8888/{stream-name}"
    echo "  WebRTC: http://192.168.1.200:8889/{stream-name}"
    echo ""
    ...
    echo ""
    echo "API:      http://192.168.1.200:9997/v3/paths/list"
