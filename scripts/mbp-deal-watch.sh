#!/bin/bash
# Cron wrapper for the MacBook Pro deal watcher.
#
...
#
#   0 7  * * * PATH=... /Users/alpuca/scripts/mbp-deal-watch.sh morning >> /Users/alpuca/logs/mbp-deal-watch.log 2>&1
#   0 17 * * * PATH=... /Users/alpuca/scripts/mbp-deal-watch.sh evening >> /Users/alpuca/logs/mbp-deal-watch.log 2>&1
set -u
...
LOCK=/tmp/mbp-deal-watch.lock
PY=/Users/alpuca/scripts/mbp-deal-watch.py

mkdir -p /Users/alpuca/logs /Users/alpuca/.mbp-deal-watch
