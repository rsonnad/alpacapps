...
export async function initAuth() {
  ...
  return new Promise((resolve) => {
    ...
    if (cached?.appUser && ['oracle', 'admin', 'staff', 'resident', 'associate', 'demon', 'public'].includes(cached.role)) {
...
export function getAuthState() {
  return {
    ...
    isAuthorized: ['oracle', 'admin', 'staff', 'resident', 'associate', 'demon', 'public', 'pending'].includes(currentRole),
