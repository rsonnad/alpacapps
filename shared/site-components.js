...
// Image URLs - transparent PNGs served locally from /assets/branding
// (was Supabase storage; bucket files went 404 — local copies live alongside the repo)
const LOGO_BASE = '/assets/branding';
