 ...
 * Also forwards to payments@alpacaplayhouse.com.
 *
...
async function sendPaymentConfirmation(
  ...
  let spaceName = 'Alpaca Playhouse';
  ...
  const emailHtml = `
    <div style="max-width:600px;margin:0 auto;background:white;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.1);font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
      <div style="background:linear-gradient(135deg,#2e7d32 0%,#1b5e20 100%);padding:32px;text-align:center;">
        ...
        <p style="color:rgba(255,255,255,0.8);margin:8px 0 0;font-size:14px;">Alpaca Playhouse</p>
      </div>
      <div style="padding:32px;">
        ...
        <p style="color:#555;font-size:14px;">Best regards,<br><strong>Alpaca Playhouse</strong></p>
      </div>
...
${balanceDue > 0 ? `Outstanding balance: ${formatCurrency(balanceDue)}\nPay now: https://alpacaplayhouse.com/pay/?amount=${balanceDue}&person_id=${row.person_id}` : 'You\'re all caught up! No outstanding balance.'}
