...
async function createPayPalOrder(
  ...
  const payload = {
    ...
    purchase_units: [{
      ...
      description: description || 'Alpaca Playhouse Payment',
      amount: {
        currency_code: 'USD',
    ...
    payment_source: {
      paypal: {
        experience_context: {
          brand_name: 'Alpaca Playhouse',
          landing_page: 'NO_PREFERENCE',
          user_action: 'PAY_NOW',
          return_url: 'https://alpacaplayhouse.com/pay/?paypal_success=true',
          cancel_url: 'https://alpacaplayhouse.com/pay/?paypal_cancelled=true',
        },
      },
    },
  };
  ...
  try {
    ...
    if (action === 'create_order') {
      ...
      const order = await createPayPalOrder(
        ...
        config,
        amount,
        description || 'Alpaca Playhouse Payment',
        internalRefId
      );
